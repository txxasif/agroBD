...
export default function LogIn() {
    ...
    return (
        ...
        <div className="form-control w-full max-w-2xl  border">
            <form className="space-y-5   w-fit mx-auto px-2 py-3" onSubmit={handleSubmit}>
                <h2 className='text-2xl font-semibold my-2 ' >Login</h2>

                <Input type="email" onChange={handleChange} placeholder="Enter Your Email" name='email' value={form.email} className="w-full max-w-xs" />
                ...
                <div className="flex flex-col items-center justify-center">
                    <SpinnerButton onClick={handleSubmit} className="w-full" name={"Login"} isLoading={loading} />
                    {/* <Button loading={true} className="w-full">Login</Button> */}
                    <p className='my-2'>Not a member? <Link href={'/signup'} className='text-red-500'>SignUp Now</Link></p>
                </div>
